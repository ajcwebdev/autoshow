...
const promptSections = {
  ...
  summary: {
    promptDescription: "- Write a one sentence description of the transcript and a one paragraph summary.\n  - The one sentence description shouldn't exceed 180 characters (roughly 30 words).\n  - The one paragraph summary should be approximately 600-1200 characters (roughly 100-200 words).\n",
  ...
  takeaways: {
    promptDescription: "- Include three key takeaways the listener should get from the episode.\n",
    example: "## Key Takeaways\n\n    1. Key takeaway goes here\n    2. Another key takeaway goes here\n    3. The final key takeaway goes here\n",
  },
  questions: {
    promptDescription: "- Include a list of 10 questions designed to check the listeners comprehension of the material contained throughout.\n  - Make sure that the questions cover all the major sections of the file.\n",
...
export function generatePrompt(sections = ['summary', 'longChapters']) {
  ...
  sections.forEach(section => {
    if (section in promptSections) {
      promptText += `${promptSections[section].promptDescription}\n`
    }
  })
