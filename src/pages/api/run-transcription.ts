...
export const POST: APIRoute = async ({ request }) => {
  ...
  try {
    ...
    console.log(`${logPrefix} Request parameters - finalPath: ${finalPath}, s3Url: ${s3Url}, service: ${transcriptServices}`)
    ...
    console.log(`${logPrefix} Using audio source: ${audioSource}`)
